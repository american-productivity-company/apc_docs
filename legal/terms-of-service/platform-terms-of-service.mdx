...
- Certain features of the Services allow Authorized Users to interact with their AI executive assistant via SMS/text message. By entering into this Agreement or otherwise using those features, Customer (and each Authorized User) expressly consents to receive SMS/text messages from Time (including messages sent by or on behalf of the executive assistant using an automatic telephone dialing system) at the mobile phone numbers they provide.  
...
- Customer represents and warrants that it and its Authorized Users have the authority to provide the mobile phone numbers submitted to Time and to consent to receive SMS/text messages as described in this Section.
